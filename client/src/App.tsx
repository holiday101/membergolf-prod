...
import SubEventStrokeNetPage from "./pages/SubEventStrokeNetPage";
import SubEventBestBallPage from "./pages/SubEventBestBallPage";
  ...
  return (
    <Routes>
      ...
      <Route element={<AppShell />}>
        ...
        <Route path="/subevents/:id/stroke-net" element={<SubEventStrokeNetPage />} />
        <Route path="/subevents/:id/bestball" element={<SubEventBestBallPage />} />
